...
echo "  bookmark edit \"Description or ID\"                      # Edit a bookmark interactively"
echo "  bookmark delete \"Description or ID\"                    # Delete a bookmark"
echo "  bookmark obsolete \"Description or ID\"                  # Mark a bookmark as obsolete"
